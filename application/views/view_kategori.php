            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" data-parsley-validate="" id="formkategori" novalidate="">
                    ...
                    <div class="form-group">
                        <label for="namakategori" class="control-label col-md-3 col-sm-3 col-xs-12">Nama kategori
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" required="required" name="namakategori" id="namakategori" data-parsley-id="5637"><ul class="parsley-errors-list" id="parsley-id-5637"></ul>
                        </div>
                    </div>
...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <table id="tabelkategori" class="table table-striped responsive-utilities jambo_table">
                    <thead>
                        <tr class="headings">
                            <th></th>
                            <th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#formkategori").submit(function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>kategori/index/update',
                type: 'POST',
                dataType: 'json',
                data: data,
            })
        ...
        var table = $('#tabelkategori').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo base_url(); ?>kategori/index/get",
            type: "POST",
            data: function (d) {
        ...
        function initEvent() {
            $(".btndelete").click(function (e) {
                ...
                if (sure) {
                    $.post("<?php echo base_url(); ?>kategori/index/delete", {'idkategori': id,aktif:aktif}, function (response) {
                        if(response.status){
                            NotifikasiToast({
                                type : 'success', // ini tipe notifikasi success,warning,info,error
                                msg : response.message, //ini isi pesan
            ...
            $(".btnedit").click(function (e) {
                ...
                $("#idkategori").val(dataedit[0]);
                $("#namakategori").val(dataedit[2]);
                if (!jendela) {
                    $("#formcollapse").click();
                    jendela = !jendela;
                };
